app.controller("MainCtrl", function($scope, $route, $rootScope, $http, $location, $timeout, $q) {
  var ctl = this;
  app.ctl = ctl;

  ctl.request = "https://ckdata.herokuapp.com/api/v1/datasets.json?group_name=Merge%20Stores"
  ctl.shop_data = null;
  ctl.activeShop =0;
  ...
  ctl.closePop = function(){ $("#detail").hide()};
  //main 
