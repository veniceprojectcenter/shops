...
app.init_slider_time = function (ctl) {
  var SliderControl = L.Control.extend({
    ...
    setObject: function () {
      ...
      this.div.innerHTML = "";
      this.div.style =
        "display: grid;width: 260px;margin-bottom: 15px;min-height: 44px;";
      var label = document.createElement("LABEL");
      label.id = "annoAC";
      label.textContent =
        "Open Store: " + ctl.activeShop + " Year: " + ctl.max_year;
  ...
  $("#slidy").on("input change", function (e) {
    ...
    document.getElementById("annoAC").textContent =
      "Open Store: " + ctl.activeShop + " Year: " + val;
